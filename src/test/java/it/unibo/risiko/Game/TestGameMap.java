...
public class TestGameMap {
    ...
    void testGetMaxPlayers() {
        ...
        assertEquals(BIG_MAP_MAX_PLAYERS, GameMap.getMaxPlayers(TEST_RESOURCES_PATH + FILE_SEPARATOR + "maps" + FILE_SEPARATOR + BIG_MAP_NAME));
    }
    ...
    void TestMap() {
        ...
        List<String> territoriesNames = territories.stream().map(t -> t.getTerritoryName()).collect(Collectors.toList());
