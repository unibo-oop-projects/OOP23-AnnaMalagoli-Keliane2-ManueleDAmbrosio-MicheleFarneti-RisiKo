...
public class TestGameMap {
    ...
    void testGetMaxPlayers() {
        ...
        assertEquals(BIG_MAP_MAX_PLAYERS,
                GameMapInitializer
                        .getMaxPlayers(testResourcePath + FILE_SEPARATOR + "maps" + FILE_SEPARATOR + BIG_MAP_NAME));
    }
    ...
    void testMarp() {
        ...
        final List<String> territoriesNames = territories.getListTerritories().stream().map(t -> t.getTerritoryName())
                .collect(Collectors.toList());
        assertEquals(List.of("Italia", "Francia", "Lichtestein", "Belgio", "San-Marino", "Monaco"), territoriesNames);
